...
path_1 = r'E:\国能竞赛\demo\1569199137000sample.csv'
path_2 = r'E:\国能竞赛\demo\1569199933000sample.csv'
...
print(new_data.head())
new_data['prediction'] = new_data.apply(lambda x: (0.8*x['prediction_x'] + x['prediction_y']*0.1+x['prediction_x']*0.1), axis=1)
