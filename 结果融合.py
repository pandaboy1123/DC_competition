...
path_1 = r'E:\国能竞赛\demo\1569040000000sample.csv'
path_2 = r'E:\国能竞赛\demo\sample1.csv'
path_3 = r'E:\国能竞赛\demo\sample.csv'
...
print(new_data.head())
new_data['prediction'] = new_data.apply(lambda x: (0.6*x['prediction_x'] + x['prediction_y']*0.2+x['prediction']*0.2), axis=1)
# print(new_data[['id','prediction']].head())
new_data[['id','prediction']].to_csv('sample.csv',index=False)