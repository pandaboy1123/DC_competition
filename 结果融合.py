...
path_1 = r'E:\国能竞赛\demo\sample1.csv'
path_2 = r'E:\国能竞赛\demo\sample2.csv'
...
print(new_data.head())
new_data['prediction'] = new_data.apply(lambda x: (0.98*x['prediction_x'] + x['prediction_y']*0.02), axis=1)
# print(new_data[['id','prediction']].head())
new_data[['id','prediction']].to_csv('psample.csv',index=False)