...
def nothing_4_real(x_pre, real_pre, name):
    plt.rcParams['font.sans-serif'] = ['SimHei']  # 用来正常显示中文标签
    plt.rcParams['axes.unicode_minus'] = False  # 用来正常显示负号
...
def K_fold(train_data, test_data, name, number, parm_list,bool):
    X = train_data[train_data['白天'] == bool][
        ['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '实际功率', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
    ...
    y = test_data[test_data['白天'] == bool][
        ['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
    ...
    dtrain = xgb.DMatrix(
        X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分','辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
    ...
    cv_res = xgb.cv(param, dtrain, num_boost_round=600, early_stopping_rounds=200, nfold=10, metrics='mae',
                    verbose_eval=True,
                    )
    bst = xgb.train(param, dtrain, num_boost_round=cv_res.shape[0])
    x_pre = bst.predict(xgb.DMatrix(X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
         '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']].values))
    real_pre = X['实际功率'].values
    res = nothing_4_real(x_pre, real_pre, name)
...
def K_fold_weather(train_data, test_data, name, number, parm_list,bool):
    X = train_data[train_data['天气'] == bool][
        ['总辐射', '风速', '风向', '温度', '湿度', '压强', '实际功率', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
         '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']]
    # y = train_data['实际功率']
    y = test_data[test_data['天气'] == bool][
        ['总辐射', '风速', '风向', '温度', '湿度', '压强',  '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
    ...
    dtrain = xgb.DMatrix(
        X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
         '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']].values, label=X['实际功率'].values)
    dtest = xgb.DMatrix(y.values)
    cv_res = xgb.cv(param, dtrain, num_boost_round=2000, early_stopping_rounds=200, nfold=10, metrics='mae',
                    verbose_eval=True,
                    )
    bst = xgb.train(param, dtrain, num_boost_round=cv_res.shape[0])
    x_pre = bst.predict(xgb.DMatrix(X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '辐照度^2', '辐照度 风速', '辐照度^3',
         '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
    ...
    res = nothing_4_real(x_pre, real_pre, name)
    score_data = pd.DataFrame()
    score_data['时间'] = train_data[train_data['天气'] == bool]['时间']
    score_data['实际功率'] = train_data[train_data['天气'] == bool]['实际功率']
    score_data['预测功率'] = res
    score_data.to_csv(r'E:\国能竞赛\dataset\score.csv', index=False)
    res_score = score.score(number, r'E:\国能竞赛\dataset\score.csv')
    log_in(name, res_score, bool)
    y_pre = bst.predict(dtest)
    pre_data = pd.DataFrame()
    pre_data['index'] = test_data[test_data['天气'] == bool]['id']
    pre_data['prediction'] = y_pre
    pre_data.to_csv('%s.csv' % name, index=False)
...
def lgb_Kfold(train_data, test_data, name, number, parm_list, bool):
    ...
    # y = train_data['实际功率']
    y = test_data[test_data['白天'] == bool][
        ['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3', '辐照度^2 风速',
         '辐照度 风速^2',
         '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
    ...
    dtrain = lgb.Dataset(
        X[['总辐射','风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
           ...
           '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']].values, label=X['实际功率'].values)
    dtest = y.values
    lgb.cv(params=param, train_set=dtrain, stratified=False, num_boost_round=3000, early_stopping_rounds=200, nfold=10,
           verbose_eval=True, metrics='mae')
    bst = lgb.train(param, dtrain)
    x_pre = bst.predict(X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
           '辐照度^2 风速', '辐照度 风速^2', '辐照度 风向^2',
           '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
           '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
...
def build_model(length):
    ...
    model.add(layers.Dense(units=128, activation='relu', input_shape=(length, )))
    ...
    model.compile(optimizer=RMSprop(lr=0.01), loss='mae', metrics=['mae'])
    return model
...
def network_k_fold(train_data, test_data, name, number, parm_list, bool):
    ...
    train = X[['总辐射', '风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
           '辐照度^2 风速', '辐照度 风速^2', '辐照度 风向^2',
           '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
           '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
           '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']]
    ...
    for i in range(k):
        ...
        注意： 默认为 1
        '''
        model.fit(partial_train_data, partial_train_targets, epochs=400, batch_size=16, verbose=1)
...
########################训练集###################
parm_list_1 = [8, 0.01, 6000]
K_fold_weather(train_data_1, test_data_1, 'station_1', 20, parm_list_1,1)
K_fold_weather(train_data_1, test_data_1, 'station_1_1', 20, parm_list_1, 0)
...
# network_K_fold_weather(train_data_1, test_data_1, 'station_1', 20, parm_list_1, 1)
# network_K_fold_weather(train_data_1, test_data_1, 'station_1_1', 20, parm_list_1, 0)
parm_list_2 = [8, 0.01, 6000]
K_fold_weather(train_data_2, test_data_2, 'station_2', 30, parm_list_2,1)
K_fold_weather(train_data_2, test_data_2, 'station_2_2', 30, parm_list_2,0)
...
# network_K_fold_weather(train_data_2, test_data_2, 'station_2', 30, parm_list_2, 1)
# network_K_fold_weather(train_data_2, test_data_2, 'station_2_2', 30, parm_list_2, 0)
parm_list_3 = [7, 0.01, 6000]
K_fold_weather(train_data_3, test_data_3, 'station_3', 10, parm_list_3,1)
K_fold_weather(train_data_3, test_data_3, 'station_3_3', 10, parm_list_3,0)
...
# network_K_fold_weather(train_data_3, test_data_3, 'station_3', 10, parm_list_3, 1)
# network_K_fold_weather(train_data_3, test_data_3, 'station_3_3', 10, parm_list_3, 0)
parm_list_4 = [7, 0.01, 6000]
K_fold_weather(train_data_4, test_data_4, 'station_4', 20, parm_list_4,1)
K_fold_weather(train_data_4, test_data_4, 'station_4_4', 20, parm_list_4,0)
...
# network_K_fold_weather(train_data_4, test_data_4, 'station_4', 20, parm_list_4, 1)
# network_K_fold_weather(train_data_4, test_data_4, 'station_4_4', 20, parm_list_4, 0)
parm_list_5 = [7, 0.01, 6000]
K_fold_weather(train_data_5, test_data_5, 'station_5', 21, parm_list_5,1)
K_fold_weather(train_data_5, test_data_5, 'station_5_5', 21, parm_list_5,0)
...
# network_K_fold_weather(train_data_5, test_data_5, 'station_5', 21, parm_list_5, 1)
# network_K_fold_weather(train_data_5, test_data_5, 'station_5_5', 21, parm_list_5, 0)
parm_list_6 = [8, 0.01, 6000]
K_fold_weather(train_data_6, test_data_6, 'station_6', 10, parm_list_6,1)
K_fold_weather(train_data_6, test_data_6, 'station_6_6', 10, parm_list_6,0)
...
# network_K_fold_weather(train_data_6, test_data_6, 'station_6', 10, parm_list_6, 1)
# network_K_fold_weather(train_data_6, test_data_6, 'station_6_6', 10, parm_list_6, 0)
parm_list_7 = [8, 0.01, 6000]
K_fold_weather(train_data_7, test_data_7, 'station_7', 40, parm_list_7,1)
K_fold_weather(train_data_7, test_data_7, 'station_7_7', 40, parm_list_7,0)
...
# network_K_fold_weather(train_data_7, test_data_7, 'station_7', 40, parm_list_7, 1)
# network_K_fold_weather(train_data_7, test_data_7, 'station_7_7', 40, parm_list_7, 0)
parm_list_8 = [8, 0.01, 6000]
K_fold(train_data_8, test_data_8, 'station_8', 30, parm_list_8,1)
K_fold(train_data_8, test_data_8, 'station_8_8', 30, parm_list_8,0)
...
# network_K_fold_weather(train_data_8, test_data_8, 'station_8', 30, parm_list_8, 1)
# network_K_fold_weather(train_data_8, test_data_8, 'station_8_8', 30, parm_list_8, 0)
parm_list_9 = [8, 0.01, 6000]
K_fold_weather(train_data_9, test_data_9, 'station_9', 50, parm_list_9,1)
K_fold_weather(train_data_9, test_data_9, 'station_9_9', 50, parm_list_9,0)
...
# network_K_fold_weather(train_data_9, test_data_9, 'station_9', 50, parm_list_9, 1)
# network_K_fold_weather(train_data_9, test_data_9, 'station_9_9', 50, parm_list_9, 0)
parm_list_10 = [8, 0.01, 6000]
K_fold_weather(train_data_10, test_data_10, 'station_10', 20, parm_list_10,1)
K_fold_weather(train_data_10, test_data_10, 'station_10_10', 20, parm_list_10,0)
...
# network_K_fold_weather(train_data_10, test_data_10, 'station_10', 20, parm_list_10, 1)
# network_K_fold_weather(train_data_10, test_data_10, 'station_10_10', 20, parm_list_10, 0)
