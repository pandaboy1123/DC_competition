...
def K_fold(train_data, test_data, name, number, parm_list):
    X = train_data[
        ['总辐射', '直辐射','散辐射','风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '实际功率', '辐照度^2', '辐照度 风速', '辐照度^3', '辐照度^2 风速',
         '辐照度 风速^2', '辐照度 风向^2',
    ...
    # y = train_data['实际功率']
    y = test_data[
        ['总辐射', '直辐射','散辐射','风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3', '辐照度^2 风速', '辐照度 风速^2',
         '辐照度 风向^2',
         '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
         '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
         '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']]
    ...
    dtrain = xgb.DMatrix(X[['总辐射', '直辐射','散辐射','风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
                            '辐照度^2 风速', '辐照度 风速^2', '辐照度 风向^2',
                            '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
                            '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
                            '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']].values, label=X['实际功率'].values)
    dtest = xgb.DMatrix(y.values)
    cv_res = xgb.cv(param, dtrain, num_boost_round=4000, early_stopping_rounds=2000, nfold=10, metrics='mae',verbose_eval=True,
                    )
...
def lgb_Kfold(train_data, test_data, name, number, parm_list):
    '''
    使用lgb进行交叉验证
    :param train_data:
    :param test_data:
    ...
    dtrain = lgb.Dataset(X[['总辐射', '直辐射','散辐射','风速', '风向', '温度', '湿度', '压强', '月', '日', '时', '分', '辐照度^2', '辐照度 风速', '辐照度^3',
                            '辐照度^2 风速', '辐照度 风速^2', '辐照度 风向^2',
                            '风速^2 湿度', '辐照度 温度^2', '辐照度 湿度^2', '辐照度 压强^2', '风速^2 风向', '风向^2 湿度', '温度^3',
                            '湿度^3', '辐照度 风速^3', '辐照度 风速 风向^2', '辐照度 风速 温度^2', '辐照度 风速 湿度^2', '辐照度 风速 压强^2',
                            '辐照度^4', '辐照度^3 风速', '风向^3 湿度', '风速 温度^3']].values, label=X['实际功率'].values)
    dtest = y.values
    lgb.cv(params=param,train_set=dtrain,stratified=False,num_boost_round=1000, early_stopping_rounds=2000,nfold=10,verbose_eval=True,metrics='mae')
...
lgb_Kfold(train_data_1, test_data_1, 'station_1', 20, parm_list_1)
...
lgb_Kfold(train_data_2,test_data_2,'station_2',30,parm_list_2)
...
lgb_Kfold(train_data_3,test_data_3,'station_3',10,parm_list_3)
...
lgb_Kfold(train_data_4,test_data_4,'station_4',20,parm_list_4)
...
lgb_Kfold(train_data_5,test_data_5,'station_5',21,parm_list_5)
...
lgb_Kfold(train_data_6,test_data_6,'station_6',10,parm_list_6)
...
lgb_Kfold(train_data_7,test_data_7,'station_7',40,parm_list_7)
...
lgb_Kfold(train_data_8,test_data_8,'station_8',30,parm_list_8)
...
lgb_Kfold(train_data_9,test_data_9,'station_9',50,parm_list_9)
...
lgb_Kfold(train_data_10,test_data_10,'station_10',20,parm_list_10)
