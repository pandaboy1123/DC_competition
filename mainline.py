...
def build_model():
    ...
    model.add(layers.Dense(units=128, activation='relu', input_shape=(33, )))
...
def network_k_fold(train_data, test_data, name, number, parm_list, bool):
    ...
    for i in range(k):
        ...
        注意： 默认为 1
        '''
        model.fit(partial_train_data, partial_train_targets, epochs=200, batch_size=16, verbose=1)
