...
# part_2_daylight(path_1,8,18)
# part_2_daylight(path_2,7,18)
# part_2_daylight(path_3,8,17)
# part_2_daylight(path_4,7,18)
# part_2_daylight(path_5,8,19)
# part_2_daylight(path_6,8,18)
# part_2_daylight(path_7,8,18)
# part_2_daylight(path_8,8,18)
# part_2_daylight(path_9,8,18)
# part_2_daylight(path_10,8,19)
...
with open(path_1,'r',encoding='utf-8') as f:
    ...
    plt.rcParams['axes.unicode_minus'] = False  # 用来正常显示负号
    data = pd.read_csv(f)
    plt.plot(data['时'],data['实际功率'],label='实际功率')
    plt.plot(data['时'], data['总辐射'],label='总辐射')
    plt.legend()
    plt.show()
